...
const Add = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Create Contact'));
    });
            ...
            <div className="pt-5 grid  grid-cols-1 gap-6">
                ...
                <div className="panel" id="forms_grid">
                    <div className="flex items-center justify-between mb-5">
                        <h5 className="font-semibold text-lg dark:text-white-light">Create Contact</h5>
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input id="email1" type="email" placeholder="Enter Email *" className="form-input" value={formData.email1} onChange={(value) => handleInputChange('email1', value)} />
                                </div>
                                <div>
