...
function AdminCalendar() {
  ...
  //       ...filteredLeaves.map(leave => leave.user_id),
  //       ...filteredPermissions.map(permission => permission.user_id)
  //     ]);
      
  //     const presentUsers = allUsers.filter(user => {
  //       return !allLeaves.some(leave => leave.user_id === user.userid && 
  //         resetTimeToMidnight(new Date(leave.from_date)) <= resetToDate && 
  //         resetTimeToMidnight(new Date(leave.to_date)) >= resetFromDate
  //       ) && 
  //       !allPermissions.some(permission => permission.user_id === user.userid && 
  //         resetTimeToMidnight(new Date(permission.date)) >= resetFromDate && 
  //         resetTimeToMidnight(new Date(permission.date)) <= resetToDate
  //       );
  //     }).map(user => ({
  //       id: `U-${user.userid}`,
  //       user_id: user.userid,
  //       user_name: user.username,
  //       from_date: format(resetFromDate, 'dd MMM yyyy'),
  //       to_date: '-',
  //       type: 'Present',
  //       status: 'Present'
  //     }));
  ...
  //         id: `L-${leave.id}`,
  //         user_id: leave.user_id, // Add User ID
  ...
  //         id: `P-${permission.id}`,
  //         user_id: permission.user_id, // Ensure this is added
