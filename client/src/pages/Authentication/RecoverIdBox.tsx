...
const LoginCover = () => {
    ...
    const [credentials, setCredentials] = useState({ email: '', password: '', otp: '', token: '', customer_id: '', confirmPassword: '' });
    ...
    const submitForm = async (e: any) => {
        ...
        try {
            ...
            let response;
            response = await userService.changePassword(credentials);
            ...
            setCredentials({ email: '', password: '', otp: '', token: '', customer_id: '', confirmPassword: '' });
            setLoader(false);
        }
                ...
                <div className="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[500px] lg:flex-row lg:gap-10 xl:gap-0">
                    ...
                    <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        ...
                        <div className="w-full max-w-[440px] ">
                            <div className="">
                                <h1 className="text-3xl font-extrabold uppercase !leading-snug text-sky-700 md:text-4xl">Reset Password</h1>
                                <p className="text-base font-bold leading-normal mb-10 text-white-dark">Enter your OTP  to reset your password</p>
                            ...
                            <form className="space-y-5 dark:text-white" onSubmit={submitForm}>
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input id="confirmPassword" type="password" value={credentials.confirmPassword}
                                            onChange={(e) => setCredentials({ ...credentials, confirmPassword: e.target.value })} placeholder="Enter Password" className="form-input ps-10 placeholder:text-white-dark" />
                                        <span className="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                <path
                                                    opacity="0.5"
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <Link to="/auth/login" className="">
                                        <label className="flex cursor-pointer items-center">
                                            <span className="text-orange-400 font-bold">Back to Login</span>
                                        </label>
                                    </Link>
                                </div>
                                <div className="flex">
